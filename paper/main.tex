...
En LTE, el canal descendente divide el espectro en bloques de recursos (RBs) de 180~kHz.
Con 10~MHz de ancho de banda hay 50~RBs disponibles por TTI (1~ms). El scheduler
...
Una consecuencia práctica de los resultados es que no existe un scheduler universalmente
óptimo, y la elección debería adaptarse al perfil de la celda. Un operador podría
usar la siguiente heurística basada en los datos:
